...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Abr-2022 às 22:01
...
CREATE TABLE `tbproduto` (
  ...
  `cod_prod` varchar(40) DEFAULT NULL,
...
INSERT INTO `tbproduto` (`idProduto`, `cod_prod`, `produto`, `quantidade`, `idCategoria`, `valor`) VALUES
(24, NULL, 'MANGUEIRA RETORNO', 0, 17, 16.8),
(25, NULL, 'sabre 16\" - usado-preto', 2, 17, 90),
(26, NULL, 'sabre 16\" - novo ', 1, 17, 130),
(27, NULL, 'corrente 28cort. pass.3/8', 1, 17, 85),
(28, NULL, 'roçadeira tbc52h', 1, 17, 980),
(30, NULL, 'guincho 150/300', 1, 22, 450),
(31, NULL, 'moto esmeril', 1, 22, 650),
(32, NULL, 'porta eletrodo', 2, 23, 50),
(37, NULL, 'carretel makita', 1, 23, 180),
(41, NULL, 'óleo 2t', 33, 24, 12),
(45, NULL, 'bomba BP1000 BV', 1, 14, 435),
(46, NULL, 'Oleo 10W30', 17, 24, 25),
(47, NULL, 'Oleo 15W40', 11, 24, 25),
(48, NULL, 'moto serra tcs46h', 1, 25, 1200),
(52, NULL, 'vela de ignição', 1, 22, 30),
(56, ' 196300003', 'carburador tbc52x', 1, 22, 120);
...
--
ALTER TABLE `tbproduto`
  MODIFY `idProduto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
